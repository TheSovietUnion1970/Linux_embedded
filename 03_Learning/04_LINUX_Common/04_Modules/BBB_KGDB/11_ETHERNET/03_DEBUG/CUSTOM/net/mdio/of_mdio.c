...
void phy_link_change_V1(struct phy_device *phydev, bool up)
{
...
EXPORT_SYMBOL_GPL(phy_link_change_V1);
				  ...
				  phy_interface_t iface)
{
	...
	phy->phy_link_change = phy_link_change_V1;
	phy->attached_dev = dev;
	phy->state = PHY_READY;
	phy->adjust_link = hndlr;
	dev->phydev = phy;
					  ...
					  void (*hndlr)(struct net_device *))
{
	...
	printk("[V] *of_phy_get_and_connect\n");

...
*/
    ...
    iowrite32(0x00, uart->base + UART_DLL);  // Clear baud divider
    iowrite32(0x00, uart->base + UART_DLH);
    ...
    /* 11. Enable RHR interrupt (optional if you're using RX IRQs) */

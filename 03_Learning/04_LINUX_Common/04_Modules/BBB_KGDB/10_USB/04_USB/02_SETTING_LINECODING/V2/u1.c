...
const u8 SetControlLineState_pkt[8] = {
    0x21,       // bmRequestType: Host-to-Device, Class, Interface
    0x22,       // bRequest: SET_CONTROL_LINE_STATE
    0x03, 0x00, // wValue: DTR=1, RTS=1 (0x0003)
...
int USB1_GetDesc_Transfer(struct usb_device_data *data){
    ...
    /* Setting control line state with new address 0x1 */
    if (ret == 0){
        ret = USB1_WRITE_Transaction(data, SetControlLineState_pkt, 0x1, NULL, 0, "SetControlLineState_pkt");
    }

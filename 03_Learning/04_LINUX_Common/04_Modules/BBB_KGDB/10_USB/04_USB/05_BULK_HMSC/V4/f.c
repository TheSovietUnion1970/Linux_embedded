            ...
            if (!valid_Root_Dir_Entry[i]) {
                ...
                if (valid_Root_Dir_Entry[i]->File_attributes == FILE_TYPE) { // SFN
                    ...
                    while(!((*tmp_Root_Dir_Entry)&END_MARKER)){
                        USB1_Gather_LFN_String(tmp_Root_Dir_Entry + 1, 10, tmp_file_name + tmp_file_name_len, 5);
                        tmp_file_name_len += 5;

                        USB1_Gather_LFN_String(tmp_Root_Dir_Entry + 14, 12, tmp_file_name + tmp_file_name_len, 6);
                        tmp_file_name_len += 6;

                        USB1_Gather_LFN_String(tmp_Root_Dir_Entry + 28, 4, tmp_file_name + tmp_file_name_len, 2);
                        tmp_file_name_len += 2;
